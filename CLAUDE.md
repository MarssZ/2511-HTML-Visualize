...
### 2. CAS 立方体演示（`demos/cas-cube/`）
- **核心概念**：通过可交互的3D立方体，展示复杂适应系统的三个交互维度（系统内、跨系统、跨层级）
- **目标用户**：普通上班族（管理者、产品经理、创业者，需要理解"任何代理都同时处于三个维度交叉点"）
- **核心技术**：原生Canvas + 3D投影算法（欧拉角旋转 + 等距投影）
- **详细文档**：
  - 需求文档：[specs/cas-cube/requirements.md](specs/cas-cube/requirements.md)
  - 设计文档：[specs/cas-cube/design.md](specs/cas-cube/design.md)
...
```
E:\MarssPython\2511-HTML-Visualize/
...
│   ├── cas-cube/                   # CAS 立方体演示
│   │   ├── index.html              # 演示页面（3D交互）
│   │   └── data.js                 # 数据文件（轴、顶点、边、节点）
│   └── demo3/                      # 未来的第三个演示
├── specs/                          # 需求和设计文档
│   ├── structure-energy/
